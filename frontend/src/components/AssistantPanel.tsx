...
import { Bot, Crosshair, Loader2, MessageCircle, Send, Sparkles } from "lucide-react";
  ...
  return (
    <>
      ...
      <div className="naskh-assistant-root" aria-live="polite">
        ...
        <button type="button" className="naskh-assistant-fab" onClick={() => onOpenChange(!open)} aria-expanded={open}>
          <MessageCircle size={18} />
          {open ? "Hide assistant" : "Ask Naskh"}
        </button>
      </div>
    </>
  );
