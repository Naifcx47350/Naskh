...
export default function App() {
  ...
  return (
    <div className="naskh-bg">
      ...
      <div className={`naskh-container flex flex-col gap-6 ${assistantOpen ? "naskh-container-assistant-open" : ""}`}>
        ...
        <section className="naskh-card p-5 sm:p-6">
          <div className="mb-4">
            ...
            <h2 className="naskh-panel-title">Sample gallery</h2>
            <p className="naskh-panel-sub">One-click, offline-ready documents for the pitch. Lead with Regulatory Circular.</p>
          </div>
          <SampleGallery onSelect={loadSample} loadingId={loadingSampleId} />
        </section>

        {!hasWorkspace && !isProcessing && !loadingSampleId && !isUploading && <EmptyWorkspace />}
